      ...
      >
        {username ? (
          ...
          <div
            ...
            className={cn(
              "w-full px-5 cursor-pointer py-3 md:py-4 flex items-center justify-center bg-gray-650 rounded-md text-sm sm:text-base text-white focus:outline-none transition duration-300 hover:bg-gradient-to-tr hover:to-orange-500 hover:from-orange-800 ",
              {
                "cursor-not-allowed bg-gray-400 hover:bg-gradient-to-tr hover:to-orange-500 hover:from-orange-800 ":
                  isEmpty,
              }
