...
const Subscription: React.FC<Props> = ({
  ...
  async function onSubmit(input: FormValues) {
    ...
    try {
      await axios("https://portal.day2daywholesale.compi/subscription", {
        method: "POST",
        data: {
  ...
  return (
    <div
      className={`${className} flex flex-col xl:flex-row justify-center xl:justify-between items-center rounded-lg bg-gradient-to-r from-orange-500 to-pink-500 py-10 mb-10 md:py-14 lg:py-16`}
    >
