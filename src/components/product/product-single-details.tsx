...
const ProductSingleDetails: React.FC = () => {
  ...
  return (
    <div className="block lg:grid grid-cols-9 gap-x-10 xl:gap-x-14 pt-7 pb-10 lg:pb-14 2xl:pb-20 items-start 2xl:pl-52 2xl:px-40">
      {showFullScreen?.length ? (
        <div className="w-screen h-screen relative">
          <div className="w-full flex justify-end absolute right-20">
            <div
              onClick={() => {
                setShowFullScreen(null);
                closeHideHeader();
              }}
              className="w-10 h-10 rounded-full bg-body flex items-center justify-center text-black z-10 cursor-pointer hover:shadow-md"
            >
              <IoMdClose size={20} />
            </div>
          </div>
