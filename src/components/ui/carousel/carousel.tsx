...
const Carousel: React.FunctionComponent<CarouselPropsType> = ({
  ...
  let nextButtonClassName = cn(
    "w-7 h-7 lg:w-8 lg:h-8 bg-orange-500 text-sm md:text-base lg:text-lg text-black flex items-center justify-center rounded-full bg-white absolute transition duration-250 hover:bg-pink-500 hover:text-white focus:outline-none transform shadow-navigation translate-x-1/2",
    {
